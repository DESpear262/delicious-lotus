/**
 * Video Player Icons
 * Simple SVG icon components for the video player
 */
...
export const VolumeOnIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg
    className={className}
    width={size}
    height={size}
...
export const VolumeOffIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg
    className={className}
    width={size}
    height={size}
