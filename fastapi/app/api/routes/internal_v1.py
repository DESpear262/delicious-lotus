...
@internal_v1_router.post("/audio-analysis", response_model=AudioAnalysisResponse)
...
@internal_v1_router.post("/process-clips", response_model=ProcessClipsResponse, status_code=status.HTTP_202_ACCEPTED)
