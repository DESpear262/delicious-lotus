...
import { useFileUpload, type UploadedAsset, type UploadState } from '@/hooks/ad-generator/useFileUpload';
import { validateFile } from '@/utils/ad-generator/fileValidation';
