...
#### 6. AI-Assisted Composition Edit
**POST** `/api/v1/compositions/{composition_id}/edit`
Natural-language video edit instructions.

**Request Body:**
```json
{
  \"instructions\": \"Trim intro to 3s and show CTA at end\",
...
{
  \"job_id\": \"gen_abc123xyz\",
  \"beat_analysis\": {\"bpm\":128, \"beats\":[0.2,0.7]},
  \"sections\": [],
  \"energy_curve\": {}
}
```
